...
import com.bumptech.glide.Glide; // Yeni eklendi: Resim yüklemek için
...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.ViewHolder> {
    ...
    public FavoritesAdapter(Context context, List<Movie> movieList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Diğer buton ve tıklama olayları burada kalabilir
        holder.btnWatchNow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Bu butona tıklandığında ne olacağını belirle, örneğin filmin detayına git
